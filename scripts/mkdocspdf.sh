...
OUTFILE_BASE="Microcontroller-Breadboard_Docs"
FORMATS="html5"
...
TITLE="Documentation for the Lloyd Albin Breadboards for Wide Microcontrollers Library v1"
AUTHOR="Lloyd Albin"

if [[ ! -d Microcontroller-Breadboard.wiki ]] ; then
	echo "Must be in the Microcontroller-Breadboard directory."
	exit 255
fi
